...
test('isPlainText: non-string inputs', () => {
    assert.strictEqual(isPlainText(null), false);
    assert.strictEqual(isPlainText(undefined), false);
    assert.strictEqual(isPlainText(123), false);
    assert.strictEqual(isPlainText({}), false);
    assert.strictEqual(isPlainText([]), false);
});
...
test('getStringType: non-string inputs', () => {
    assert.strictEqual(getStringType(null), 'invalid');
    assert.strictEqual(getStringType(undefined), 'invalid');
    assert.strictEqual(getStringType(123), 'invalid');
    assert.strictEqual(getStringType({}), 'invalid');
    assert.strictEqual(getStringType([]), 'invalid');
});
